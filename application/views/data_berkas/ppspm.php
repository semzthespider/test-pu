                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                        ...
                        foreach($list_->result() as $row){
                          ...
                          $links = '<a href="'.base_url('C_ppspm/view/'.$row->kd_pembebanan).'"class="btn btn-info ">'.$row->untuk_pembayaran.'<i ></i></a>';
                          echo '
                                <tr>
                                  <td>'.$no++.'</td>
                                  <td>'.$links.'</td>
                            ...
                            echo '<a href="'.base_url('C_ppspm/print_surat/'.$row->kd_pembebanan).'"  class="btn btn-primary ">Print<i ></i></a> ';
                          if($permit['d']==1)
                          echo '</td>
                                </tr>';
                        }
