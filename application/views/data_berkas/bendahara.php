                      ...
                      <!-- END EXAMPLE TABLE PORTLET-->
                        ...
                        foreach($list_->result() as $row){
                          if($row->id_penerima==1)
                            ...
                            {
                              $ad ='<a href="'.base_url('C_bendahara/selesai/'.$row->kd_pembebanan).'"  class="btn btn-info ">Selesai<i ></i></a>';
                            }
                           else
                           {
                          ...
                          echo '
                            ...
                            echo '<a href="'.base_url('C_bendahara/print/'.$row->kd_pembebanan).'"  class="btn btn-primary ">Print<i ></i></a> ';
                          if($permit['d']==1){
                          echo ' <a  href="'.base_url('C_bendahara/delete/'.$row->kd_pembebanan).'" class="btn btn-danger alert_notif">Hapus<i ></i></a> ';
                          }
                          echo '</td>
                                </tr>';
                        }
