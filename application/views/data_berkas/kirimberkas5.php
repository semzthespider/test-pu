...
?>    
  <?php
                                  ...
                                  echo form_open('C_bendahara/update');
                 ...
                 <div class="col-md-6 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <!-- start form for validation -->
                      ...
                      <p>
                        Send:
                        <input type="radio" class="flat" name="jenisanggaran" id="genderM" value="<?php echo $r->jenisanggaran*2 ?>" checked="" required />
                        Draft:
                        
                        <input type="radio" class="flat" name="jenisanggaran" id="genderF" value="<?php echo $r->jenisanggaran ?>" />
                      </p>
