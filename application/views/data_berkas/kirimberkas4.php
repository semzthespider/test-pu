                 ...
                 <div class="col-md-6 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <!-- start form for validation -->
                      ...
                      <p>
                        Send:
                        <input type="radio" class="flat" name="id_penerima" id="genderM" value="5" checked="" required />
                        Draft:
                        <input type="radio" class="flat" name="id_penerima" id="genderF" value="4" />
                      </p>
